    ...
    <div className="min-h-[100dvh] bg-background text-foreground font-sans overflow-x-hidden w-full relative">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 py-4 px-6 md:px-12 backdrop-blur-md bg-background/80 border-b border-border/50">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-sans font-bold text-xl text-foreground tracking-tight">Daymark</span>
          </div>
          <div className="flex items-center gap-4">
            ...
            <Link href="/onboarding" className="bg-primary text-white px-5 py-2.5 rounded-full text-sm font-bold shadow-md shadow-primary/20 hover:scale-105 transition-transform active:scale-95">
              Start
            </Link>
          </div>
        </div>
      ...
      <section className="pt-32 pb-20 md:pt-48 md:pb-32 px-6 md:px-12 max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center gap-12 lg:gap-24 min-h-[90vh]">
        ...
        >
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-sans font-extrabold leading-[1.05] text-foreground tracking-tight">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
            <Link href="/onboarding" className="w-full sm:w-auto bg-primary text-white px-8 py-4 rounded-full text-lg font-bold shadow-xl shadow-primary/30 flex items-center justify-center gap-2 hover:scale-105 transition-transform active:scale-95 group">
              Start Your Daymark
        ...
        <motion.div 
          ...
          className="flex-1 relative w-full aspect-square md:aspect-auto md:h-[600px] rounded-[2rem] overflow-hidden shadow-2xl shadow-primary/10 border-8 border-white bg-lavender/50"
        >
      ...
      <section id="how-it-works" className="py-24 bg-white relative border-y border-border">
        <div className="max-w-4xl mx-auto px-6 text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-sans font-bold tracking-tight mb-6">Every moment is a gift waiting to be opened.</h2>
      ...
      <section className="py-32 px-6 bg-lavender/30 relative overflow-hidden">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-16">
          <div className="flex-1 w-full max-w-md mx-auto">
            <div className="bg-white p-8 rounded-[2rem] shadow-xl relative rotate-[-2deg] border border-border">
              ...
              <div className="aspect-square bg-muted rounded-[20px] mb-6 flex flex-col items-center justify-center text-center p-6 border-2 border-dashed border-primary/20">
                ...
                <h4 className="font-sans font-bold text-2xl tracking-tight">A Gift for Later</h4>
          ...
          <div className="flex-1 space-y-6">
            <h2 className="text-4xl md:text-5xl font-sans font-bold tracking-tight">Send a gift to the future.</h2>
      ...
      <section className="py-32 px-6 bg-primary text-primary-foreground text-center relative overflow-hidden">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-sans font-bold tracking-tight mb-6 text-white">Ready to start keeping?</h2>
      ...
      <footer className="py-12 px-6 border-t border-border bg-white text-center">
        <div className="flex items-center justify-center gap-2 mb-4">
          ...
          <span className="font-sans font-bold text-lg">Daymark</span>
        </div>

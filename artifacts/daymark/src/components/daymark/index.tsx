      ...
      <button
        ...
        className={cn(
          "rounded-full px-6 py-3 font-bold transition-all active:scale-95 inline-flex items-center justify-center",
          {
            ...
            "shadow-glow": variant === "primary" && glow,
...
export const DmMemoryCard = ({ title, date, category, giftColor, photoUrl, people, isKeptClose }: DmMemoryCardProps) => {
  return (
    <div className="bg-white rounded-[20px] overflow-hidden shadow-sm border border-border flex flex-col h-full hover:shadow-md transition-shadow">
      <div className="relative aspect-[4/3] w-full bg-muted flex-shrink-0">
        {photoUrl ? (
          ...
          <div 
            ...
            style={{ 
              background: `repeating-linear-gradient(45deg, ${giftColor}, ${giftColor} 10px, transparent 10px, transparent 20px)`,
              backgroundColor: `${giftColor}40`
            }} 
          />
        )}
        {/* Ribbon overlay top */}
      ...
      <div className="p-3 py-2 flex flex-col flex-1 relative">
        <div className="mb-1">
        ...
        {people && people.length > 0 && (
          <div className="flex -space-x-1 mt-2">
            {people.slice(0, 3).map((person, i) => (
              <div key={i} className="w-5 h-5 rounded-full border border-white bg-lavender flex items-center justify-center overflow-hidden">
                {person.avatarUrl ? (
  ...
  return (
    <div className="flex flex-col items-center gap-1.5 w-[72px]">
      <div className="relative">
        <div 
          className="rounded-full bg-lavender flex items-center justify-center overflow-hidden border-2 border-white shadow-sm"
...
// --- DmBottomSafeArea ---
export const DmBottomSafeArea = () => <div className="h-32 w-full" />;
